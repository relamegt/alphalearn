        ...
        return (
            <div className="max-w-4xl mx-auto space-y-8 animate-pulse">
                    ...
                    <div className="p-6">
                        <div className="flex flex-col md:flex-row md:items-end gap-4">
                            ...
                            <div className="flex gap-2">
                                <div className="w-24 h-11 bg-gray-200 rounded-lg shrink-0"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-yellow-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-yellow-100 bg-yellow-50/50">
                        <div className="w-48 h-6 bg-gray-200 rounded"></div>
                    </div>
                    <div className="p-6 space-y-6">
                        {[1, 2, 3, 4, 5].map(i => (
                            <div key={i} className="flex flex-col md:flex-row md:items-end gap-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                                <div className="flex-grow space-y-2">
                                    <div className="w-32 h-4 bg-gray-200 rounded"></div>
                                    <div className="w-full h-11 bg-gray-200 rounded-lg"></div>
                                </div>
