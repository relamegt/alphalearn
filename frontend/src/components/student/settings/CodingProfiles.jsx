...
const CodingProfiles = () => {
    ...
    if (initialLoading) {
        return (
            <div className="max-w-4xl mx-auto space-y-8 animate-pulse">
                ...
                <div className="bg-white dark:bg-[#0a0f1a] rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden transition-colors">
                ...
                <div className="bg-white dark:bg-[#0a0f1a] rounded-xl shadow-sm border border-yellow-200 dark:border-yellow-900 overflow-hidden transition-colors">
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            <div className="bg-white dark:bg-[#0a0f1a] rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden transition-colors">
                <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-gradient-to-r from-gray-50 to-white dark:from-[#1a2234] dark:to-[#0a0f1a]">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                        <svg className="w-5 h-5 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg>
                        Development Profile
                    </h2>
                </div>
                <div className="p-6">
                    <div className="flex flex-col md:flex-row md:items-end gap-4">
                        <div className="flex-grow space-y-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-white dark:bg-[#0a0f1a] border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all shadow-sm"
                        ...
                        <div className="flex gap-2">
                            ...
                            {codingData.github && (
                                <a
                                    ...
                                    className="bg-white dark:bg-[#0a0f1a] hover:bg-gray-50 dark:hover:bg-[#141b2b] text-blue-600 dark:text-blue-400 border border-gray-200 dark:border-gray-700 p-2.5 rounded-lg transition-all shadow-sm hover:shadow h-[44px] w-[44px] flex items-center justify-center"
            ...
            <div className="bg-white dark:bg-[#0a0f1a] rounded-xl shadow-sm border border-yellow-200 dark:border-yellow-900/50 overflow-hidden ring-1 ring-yellow-100/50 dark:ring-yellow-900/20 transition-colors">
                <div className="px-6 py-4 border-b border-yellow-100 dark:border-yellow-900/30 bg-gradient-to-r from-yellow-50 to-white dark:from-yellow-900/10 dark:to-[#0a0f1a]">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                        ...
                        <div key={platform.value} className="flex flex-col md:flex-row md:items-end gap-4 pb-4 border-b last:border-b-0 border-gray-100 dark:border-gray-800 last:pb-0">
                            <div className="flex-grow space-y-2 relative">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-white dark:bg-[#0a0f1a] border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 outline-none transition-all shadow-sm"
                            ...
                            <div className="flex gap-2">
                                ...
                                {codingData[platform.value] && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="bg-white dark:bg-[#0a0f1a] hover:bg-gray-50 dark:hover:bg-[#141b2b] text-blue-600 dark:text-blue-400 border border-gray-200 dark:border-gray-700 p-2.5 rounded-lg transition-all shadow-sm hover:shadow h-[44px] w-[44px] flex items-center justify-center group"
