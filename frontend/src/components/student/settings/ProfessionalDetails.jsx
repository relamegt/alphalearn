                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={label} className="space-y-1.5 transition-colors">
                                    ...
                                    <div className="text-gray-900 dark:text-gray-100 font-medium py-2 px-3 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-lg shadow-sm">
