...
const ProblemList = () => {
    ...
    if (loading) {
        return (
            <div className="h-screen flex flex-col bg-[#F7F5FF] dark:bg-[#111117] transition-colors">
                {/* Header Skeleton */}
                <div className="h-14 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#111117] flex items-center px-4 justify-between animate-pulse">
                ...
                <div className="flex-1 flex overflow-hidden animate-pulse">
                    ...
                    <div className="w-1/2 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-[#111117] p-6 flex flex-col gap-4">
                    ...
                    <div className="w-1/2 flex flex-col">
                        <div className="h-10 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#111117] flex items-center px-4 gap-2">
                            <div className="w-20 h-6 bg-gray-200 dark:bg-gray-800 rounded"></div>
                            <div className="w-20 h-6 bg-gray-200 rounded"></div>
                        </div>
                        <div className="flex-1 bg-white dark:bg-[#111117] p-6 flex flex-col gap-4">
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-[#F7F5FF] dark:bg-[#111117] text-gray-500 dark:text-gray-400 transition-colors">
